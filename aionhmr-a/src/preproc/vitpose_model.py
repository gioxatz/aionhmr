...
MODEL_DIR = "/gpu-data2/gchatz/slahmr"
...
class ViTPoseModel(object):
    MODEL_DICT = {
        "ViTPose-B (multi-task train, COCO)": {
            ...
            "model": f"{MODEL_DIR}/_DATA/vitpose_ckpts/vitpose-b-multi-coco.pth",
        },
        "ViTPose-L (multi-task train, COCO)": {
            ...
            "model": f"{MODEL_DIR}/_DATA/vitpose_ckpts/vitpose-l-multi-coco.pth",
        },
        "ViTPose-G (multi-task train, COCO)": {
            "config": f"{VIT_DIR}/configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/ViTPose_huge_coco_256x192.py",
            "model": f"{MODEL_DIR}/_DATA/vitpose_ckpts/vitpose-h-multi-coco.pth",
        },
    }
