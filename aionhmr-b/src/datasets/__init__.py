...
class AionHMRDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self) -> Dict:
        ...
        """
        print("NUM OF WORKERS: ", self.cfg.GENERAL.NUM_WORKERS)
        train_dataloader = torch.utils.data.DataLoader(self.train_dataset, self.cfg.TRAIN.BATCH_SIZE, drop_last=True, num_workers=1, prefetch_factor=self.cfg.GENERAL.PREFETCH_FACTOR)
