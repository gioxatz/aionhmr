...
from .heads import build_smpla_head
...
class AionHMRb(pl.LightningModule):
    ...
    def __init__(self, cfg: CfgNode, init_renderer: bool = True):
        ...
        # Create SMPL-A head
        self.smpl_head = build_smpla_head(cfg)
        ...
        self.smpla_parameter_loss = ParameterLoss()
    ...
    def configure_optimizers_lora(self):
        # Filter only parameters that actually require gradients
    ...
    def forward_step(self, batch: Dict, train: bool = False) -> Dict:
        ...
        conditioning_feats = conditioning_feats
        ...
        # print(pred_smpl_params['betas'].shape, "pred betas shape")
    ...
    def compute_loss(self, batch: Dict, output: Dict, train: bool = True) -> torch.Tensor:
        ...
        for k, pred in pred_smpl_params.items():
            ...
            # print(gt_smpl_params, "gt_smpl_params")
            loss_smpl_params[k] = self.smpla_parameter_loss(pred.reshape(batch_size, -1), gt.reshape(batch_size, -1), has_gt)

        # keypoints 2d have greater weight than the rest
    ...
    def training_step_discriminator(self, batch: Dict,
        ...
        # print(gt_betas, "gt betas", betas.shape, "betas")
        # print(gt_rotmat.shape, "gt rotmat")
        ...
        # print("gt_rotmat, gt_betas", gt_rotmat.shape, gt_betas.shape)
    ...
    def training_step(self, joint_batch: Dict, batch_idx: int) -> Dict:
        ...
        optimizer.step()
        if self.cfg.LOSS_WEIGHTS.ADVERSARIAL > 0:
            # print("pred_smpl_params['betas'].shape:", pred_smpl_params['betas'].shape)
