from .smpla_wrapper import SMPL
from .aionhmrb import AionHMRb
from .discriminator import Discriminator

from ..utils.download import cache_url
from ..configs import CACHE_DIR_AIONHMR
from peft import PeftModel

def download_models(folder=CACHE_DIR_AIONHMR):
...
def load_aionhmr(checkpoint_path=DEFAULT_CHECKPOINT):
    ...
    print(f"Loading AionHMR-b model from checkpoint: {checkpoint_path}\n")
   
    model = AionHMRb.load_from_checkpoint(checkpoint_path, strict=False, cfg=model_cfg)
