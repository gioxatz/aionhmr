...
CACHE_DIR_AIONHMR = os.path.join(CACHE_DIR, "AionHMR")
...
def get_config(config_file: str, merge: bool = True, update_cachedir: bool = False) -> CN:
    ...
    if update_cachedir:
      ...
      # print(cfg.SMPL.MEAN_PARAMS, "cfg MEAN PARAMS")

      # data_dir = cfg.SMPL.DATA_DIR
      # cfg.SMPL.MODEL_PATH = os.path.join(data_dir, "smpl")
